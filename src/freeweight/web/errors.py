...
_STATUS_BY_CODE: dict[str, int] = {
    ...
    "COMPARISON_SUBJECT_NOT_FOUND": status.HTTP_404_NOT_FOUND,
    "COMPARISON_REFUSED": status.HTTP_400_BAD_REQUEST,
    "GOAL_NOT_FOUND": status.HTTP_404_NOT_FOUND,
    "GOAL_INVALID": status.HTTP_400_BAD_REQUEST,
    "GOAL_PACK_INCOMPATIBLE": status.HTTP_400_BAD_REQUEST,
    "GOAL_PATH_UNSAFE": status.HTTP_400_BAD_REQUEST,
    "GOAL_HASH_MISMATCH": status.HTTP_400_BAD_REQUEST,
    "CALIBRATION_INSUFFICIENT": status.HTTP_409_CONFLICT,
    "CALIBRATION_REQUIRED": status.HTTP_409_CONFLICT,
    "JUDGE_UNAVAILABLE": status.HTTP_503_SERVICE_UNAVAILABLE,
    "REMOTE_JUDGE_NOT_PERMITTED": status.HTTP_403_FORBIDDEN,
    "JUDGE_SELF_JUDGING_REFUSED": status.HTTP_409_CONFLICT,
    "PROMPT_OVERRIDE_REFUSED": status.HTTP_409_CONFLICT,
    "CONTEXT_FIT_REQUIRED": status.HTTP_409_CONFLICT,
    "CONFLICT": status.HTTP_409_CONFLICT,
    "RUN_NOT_CANCELLABLE": status.HTTP_409_CONFLICT,
    "RUN_ALREADY_RUNNING": status.HTTP_409_CONFLICT,
    "RUN_NOT_GRADEABLE": status.HTTP_409_CONFLICT,
    "DRAFT_REFUSED": status.HTTP_409_CONFLICT,
