...
**Status:** `1.1.2` in the repository (tagged `v1.1.2`; `pip index versions freeweight` says what PyPI serves). Phases 1–15 built, through the adapter arc's LA3 checkpoint. Every
